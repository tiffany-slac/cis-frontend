...
function EditActivityForm({ showEditActivity, setshowEditActivity }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            setshowEditActivity(false); // Close the form
...
const handleInputChange = (e) => {
    ...
    return (
        <div className={`modal ${showEditActivity ? "show" : "hide"}`}>
            <div className="form-content">
                <span className="close" onClick={() => setshowEditActivity(false)}>
                    &times;
                </span>
